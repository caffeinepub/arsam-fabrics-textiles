...
export interface _SERVICE {
  ...
  'createProduct' : ActorMethod<
    [string, string, bigint, number, string, boolean, boolean],
    bigint
  >,
  ...
  'getAllCustomOrders' : ActorMethod<[], Array<CustomOrderRequest>>,
  ...
  'updateProduct' : ActorMethod<
    [bigint, string, string, bigint, number, string, boolean, boolean],
    undefined
  >,
}
