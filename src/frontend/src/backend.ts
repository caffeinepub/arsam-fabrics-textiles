...
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: string, arg2: bigint, arg3: number, arg4: string, arg5: boolean, arg6: boolean): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllCustomOrders(): Promise<Array<CustomOrderRequest>> {
        if (this.processError) {
            try {
    ...
    async submitCustomOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCustomOrder(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: number, arg5: string, arg6: boolean, arg7: boolean): Promise<void> {
        if (this.processError) {
            try {
